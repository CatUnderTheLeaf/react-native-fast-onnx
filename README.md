# react-native-fast-onnx

react-native-fast-onnx is a react native package to run onnx models built with Nitro
...
```bash
npm install react-native-fast-onnx react-native-nitro-modules
```
